...
python run_gen.py --do_train --do_eval --do_eval_bleu --do_test  \
	...
	--cache_path /home/aumahesh/w266-summer-2022-project/data/finetuned/cache  \
	--output_dir /home/aumahesh/w266-summer-2022-project/data/finetuned/output  \
	--summary_dir /home/aumahesh/w266-summer-2022-project/data/finetuned/summary \
	--save_last_checkpoints --always_save_model \
	--res_dir /home/aumahesh/w266-summer-2022-project/data/finetuned/results --res_fn mrv_res.txt \
